    ...
    <section id="htc__who">
        ...
        <div className="container htc-who_container">
            ...
            <div className="who_item">
                ...
                From the banking sector to the health and education departments, every field has paperwork to deal with. There can be loads of printed or handwritten official documents that need to be digitized. It can be done easily with the use of our OCR-based image text converter. The data entry specialists just need to process the scanned copies of the documents through our tool and it will take no time to convert them into the textual form which can be easily edited and stored in the computer system.
                </p>
                <h3 className="who_head">2. Linguistic Researchers</h3>
                <p className="who_info">
